          ...
          <ul class="nav nav-tabs">
            ...
            <div class="col-md-6">
               ...
               <h3 class="text-center">Pre-Requisite</h3>
                <div class="form-group {{$errors->has('requisite_subject_code') ? 'has-error': ''}}">
                  ...
                  <input type="text" name="requisite_subject_code" class="form-control" placeholder="Enter Subject Code" maxlength="15">
                ...
                <div class="form-group {{$errors->has('requisite_subject_description') ? 'has-error': ''}}">
                  ...
                  <textarea class="form-control" name="requisite_subject_description" placeholder="Enter Subject Description" maxlength="100"></textarea>
            ...
            <div class="col-md-6">
               ...
               <div class="form-group {{$errors->has('new_subject_code') ? 'has-error': ''}}">
                  <label>Subject Code</label>
                  <input type="text" name="new_subject_code" class="form-control" placeholder="Enter Subject Code" maxlength="15">
                ...
                <div class="form-group {{$errors->has('new_subject_description') ? 'has-error': ''}}">
                  <label>Subject Description</label>
                  <textarea class="form-control" name="new_subject_description" placeholder="Enter Subject Description" maxlength="100"></textarea>
                ...
                <div class="form-group">
                  <label>Subject Year Level</label>
                  <select name="year" class="form-control">
                    <option>Select Subject Year Level</option>
