...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="row">
           <h1 class="text-center">{{$find->subject_code}}</h1>
           ...
           <table class="table table-striped">
             ...
             <tbody>
               @foreach($students as $morls)
                <tr>
                  <td>{{$morls->student->fname}} {{$morls->student->lname}}</td>
                  <td>{{$morls->subject->student_year}}</td>
                  <td>{{$morls->subject->semester}}</td>
