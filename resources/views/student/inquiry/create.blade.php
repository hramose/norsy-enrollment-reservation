...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          <div class="row">
            @if(Session::has('ok'))
              <div class="alery alert-success">{{Session::get('ok')}}</div>
            @endif
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              <form action="{{route('student_inquiry_check')}}" method="POST">
                <div class="form-group {{$errors->has('inquiry_title') ? 'has-error' : ''}}">
                  ...
                  <input type="text" name="inquiry_title" class="form-control" placeholder="Enter Inquiry Title Here" maxlength="120"> 
                ...
                <div class="form-group {{$errors->has('inquiry_content') ? 'has-error' : ''}}">
                  ...
                  <textarea class="form-control" name="inquiry_content" placeholder="Enter Inquiry Content Here" rows="5"></textarea>
